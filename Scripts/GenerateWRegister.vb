...
Public NumberToSearch As String
Public MIDValue As String 'Not used in this code
Private Sub TextBox1_Change() 'Checks if the inputed value is a number.
    Dim EntryFirst As String
    EntryFirst = TextBox1.Text
...
Public Sub DataUpdate()
    ...
    NumberToSearch = TextBox1.Value 'Searches for the inserted value inside DB
    Set Cell = Sheets("Control IT").Range("B:B").Cells.Find(What:=NumberToSearch, LookAt:=xlWhole)
